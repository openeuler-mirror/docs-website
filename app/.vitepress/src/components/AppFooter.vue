...
import { linksData2, quickNav, friendshipLinks, filingData } from '@/config/footer';
...
<template>
  <div id="tour_footer" class="app-footer">
    ...
    <div class="footer-content">
      <ContentWrapper :pc-top="0" :mobile-top="0">
        <div class="quick-nav">
          <div v-for="category in quickNav[lang]" :key="category.title" class="category">
            <div class="category-title">
              {{ category.title }}
            </div>
            <ul class="navs">
              <li v-for="nav in category.list" :key="nav.link" class="nav">
                <a :href="nav.link.includes('http') ? nav.link : `${baseUrl}${nav.link}`" target="_blank" rel="noopener noreferrer">{{ nav.title }}</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="inner">
          ...
          <div class="footer-option">
            ...
            <div class="copyright">
              ...
              <div class="filing">
                <a :href="filingData.link" target="_blank" rel="noopener noreferrer" class="filing-link">
