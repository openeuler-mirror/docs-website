  ...
  NAV_ROUTER: [
    {
          ...
          children: [
            {
              ...
              tag: TAG_TYPE.NEW,
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/download/#openEuler 24.03 LTS SP4`,
            },
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/download/#openEuler 24.03 LTS SP3`,
            },
            {
              label: 'openEuler 24.03 LTS SP1',
              description:
                '基于6.6内核的24.03 LTS版本增强扩展版本，面向服务器、云、边缘计算和嵌入式场景，持续提供更多新特性和功能扩展，给开发者和用户带来全新的体验，服务更多的领域和更多的用户。',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/download/#openEuler 24.03 LTS SP1`,
            },
            {
              label: '其他获取方式',
              description: '通过公有云、容器镜像等方式获取openEuler版本',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/download/#get-openeuler`,
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/download/commercial-release/`,
            },
          ],
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/mirror/list/`,
            },
            {
              label: 'Repo源',
      ...
      shortcut: [
        {
          label: '查询所有版本',
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/download?archive=true`,
        },
        {
          label: '版本生命周期',
        ...
        {
          label: '技术白皮书',
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/showcase/technical-white-paper/`,
        },
      ],
    },
    {
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/sig/sig-list/`,
            },
            {
              label: 'CLA签署',
            ...
            },
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/community/contribution/`,
            },
            {
              label: 'oEEP',
              description: '查看openEuler社区的演进提案',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/oEEP/?name=oEEP-0000 oEEP  索引`,
            },
          ],
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              href: `${import.meta.env.VITE_SERVICE_SOFTWARE_PKG_URL}/zh/package`,
            },
            {
              label: 'License工具门户',
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/other/projects/atune/`,
            },
            {
              label: 'iSula',
              description: '容器技术方案',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/other/projects/isula/`,
            },
            {
              label: 'secGear',
              description: '开发安全应用的机密计算框架',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/other/projects/secgear/`,
            },
            {
              label: 'NestOS',
              description: '基于欧拉开源操作系统的云底座操作系统',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/nestos`,
            },
            {
              label: '全部项目',
              description: '',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/projects`,
      ...
      shortcut: [
        {
          label: '企业签署CLA流程',
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/blog/2022-11-25-cla/CLA%E7%AD%BE%E7%BD%B2%E6%B5%81%E7%A8%8B.html`,
        },
        {
          label: 'CLA-FAQ',
          icon: OutLink,
        ...
        {
          label: '开发者日历',
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/meeting/#calendar`,
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              tag: TAG_TYPE.HOT,
              href: `${import.meta.env.VITE_SERVICE_DOCS_URL}/zh/docs/24.03_LTS_SP4/server/quickstart/quickstart/quick_start.html`,
            },
            {
              label: '安装指南',
            ...
            },
            {
              ...
              href: `${import.meta.env.VITE_SERVICE_DOCS_URL}/zh/docs/common/faq/general/general_faq.html`,
            },
            {
              label: '文档开发指南',
              description: '参与文档开发的方式',
              href: `${import.meta.env.VITE_SERVICE_DOCS_URL}/zh/docs/common/contribute/directory_structure_introductory.html`,
            },
          ],
        },
      ],
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/learn/mooc/`,
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/universities/`,
            },
            {
              label: '人才培养',
              description: '帮助企业快速培养openEuler专业生态人才',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/talent-assessment/`,
            },
            {
              label: '开源实习',
              description: '帮助在校学生在项目实践中提升能力，成为优秀的开源人才',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/internship/`,
            },
          ],
        },
      ],
      shortcut: [
        {
          ...
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/learn/mooc/detail/`,
        },
        {
          label: 'openEuler精品课程',
        ...
        {
          label: '活动与大赛',
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/universities/#%E6%B4%BB%E5%8A%A8%E4%B8%8E%E5%A4%A7%E8%B5%9B`,
        },
        {
          label: '高校技术小组',
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/universities/#%E9%AB%98%E6%A0%A1%E6%8A%80%E6%9C%AF%E5%B0%8F%E7%BB%84`,
        },
      ],
    },
    {
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/compatibility/`,
            },
            {
              label: '兼容性技术测评',
            ...
            },
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/approve/`,
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/migration/`,
            },
            {
              label: '运维专区',
              description: 'openEuler运维全集和工具',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/om/`,
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/security/security-bulletins/`,
            },
            {
              label: '缺陷中心',
              description: '查看缺陷相关安全问题',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/security/bug-bulletins/`,
            },
          ],
        },
      ],
      shortcut: [
        {
          ...
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/compatibility/hardware/`,
        },
        {
          label: 'OSV技术测评整体介绍',
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/approve/approve-step/`,
        },
        {
          label: '迁移工具x2openEuler',
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/migration/download/`,
        },
        {
          label: '迁移实践',
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/migration/user-cases/`,
        },
        {
          label: 'FAQ',
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/community/organization/`,
            },
            {
              label: '社区章程',
              description: '了解openEuler的章程、条例、行为准则、License策略',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/community/charter/`,
            },
            {
              label: '成员单位',
              description: '了解openEuler的捐赠单位',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/community/member/`,
            },
            {
              label: '社区荣誉',
              description: '了解openEuler的荣誉奖项',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/community/honor/`,
            },
            {
              label: '城市用户组',
              description: '区域用户交流圈',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/community/user-group/`,
            },
            {
              label: '贡献看板',
            ...
            },
            {
              label: '联系我们',
              description: '社区联系方式',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/contact-us/`,
            },
            {
              label: '用户案例',
              description: '了解openEuler在各行业的最佳案例',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/showcase/`,
            },
            {
              label: '白皮书',
            ...
            },
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/showcase/market-report/`,
            },
          ],
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/community/mailing-list/`,
            },
            {
              label: '线上会议',
              description: '查询并参与SIG组例会',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/meeting/`,
            },
            {
              label: 'QuickIssue',
      ...
      shortcut: [
        {
          ...
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/whitepaper/openEuler %E5%BC%80%E6%BA%90%E7%A4%BE%E5%8C%BA%E4%BB%8B%E7%BB%8D.pdf`,
        },
        {
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/interaction/event-list/`,
            },
            {
              label: '峰会',
              description: '查看openEuler年度大会详情',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/interaction/summit-list/devday2026/`,
            },
            {
              label: 'openEuler Call for X计划',
              description: '共享openEuler Call for X计划多元化资源',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/community/program/`,
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/interaction/news-list/`,
            },
            {
              label: '博客',
              description: '查看openEuler技术文章分享',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/interaction/blog-list/`,
            },
            {
              label: '月刊与年报',
              description: '查看openEuler社区运作报告',
              href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/monthly-bulletins/`,
            },
          ],
        },
      ],
      shortcut: [
        {
          ...
          picture: Odd,
          description: 'openEuler Developer Day 2026 （简称 ODD 2026）是开放原子开源基金会孵化及运营的 openEuler 社区发起的开发者大会。',
        ...
        },
        {
          ...
          type: 'PICTURE',
          href: `${import.meta.env.VITE_MAIN_DOMAIN_URL}/zh/interaction/summit-list/summit2025/`,
        },
      ],
    },
  ],
